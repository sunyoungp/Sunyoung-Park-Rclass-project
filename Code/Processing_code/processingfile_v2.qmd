...
Rename the names of variables to keep them short and easy for cleaning and using the code.
...
Remove study name, id, and sn as they are not necessary for data analysis.
